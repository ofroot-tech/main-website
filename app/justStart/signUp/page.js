  ...
  return (
     <div className="page">
          ...
          <ul>     
            ...
            <li>
              ...
              <hr></hr>
                ...
                <li>
                <Link href="/justStart/signIn">Sign In</Link>
              </li>     
                <hr></hr>
            {/* <li>
      ...
      <section className="jumbotron">
        <h1 className="jumbotronTitle">Sign Up</h1>
        <p className="jumbotronSubtitle">Join Just Start and grow your business today!</p>
      </section>
